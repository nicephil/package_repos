...
CWBool CWAssembleConfigureRequest(CWProtocolMessage **messagesPtr,
    ...
    CWDebugLog_F("Assembling Configure Request...");
    ...
    CWDebugLog_F("Configure Request Assembled");
	return CW_TRUE;
}
...
CWBool CWParseConfigureResponseMessage (char *msg,
	...
	CWDebugLog_F("Parsing Configure Response...");
	...
	if (controlVal.messageTypeValue != CW_MSG_TYPE_VALUE_CONFIGURE_RESPONSE) {
        ...
        sprintf(errinfo, "Message(%d) is not Configure Response as Expected", 
    ...
    CWDebugLog_F("Configure Response Parsed");
	return CW_TRUE;
}
...
CWBool CWSaveConfigureResponseMessage(CWProtocolConfigureResponseValues *configureResponse) {
    ...
    CWDebugLog_F("Saving Configure Response...");
	...
	if(configureResponse->echoRequestTimer > 0) {
		...
		g_capwapc_config.echo_intv = configureResponse->echoRequestTimer;
	}
	...
	*/
    ...
    CWDebugLog_F("Configure Response Saved");
	return CW_TRUE;	
}

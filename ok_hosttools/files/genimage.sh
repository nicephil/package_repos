#!/bin/bash
swversion=$1
origin_files__bin_files="openwrt-mtkmips-mt7621-vmlinux-initramfs.elf|vmlinux_hcmt7621-n256_16M.gz|hcmt7621-n256"
...
function add_new_release() 
{
    ...
    img_url="http://image.oakridge.vip:8000/images/ap/hcmt7621-n256/okos/${img_name}"

    all_types="HCMT7621-N256"
    url="api.oakridge.io"

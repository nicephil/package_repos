...
const dc_json_node dc_nodes[] = {
    ...
    {"users",           dc_hdl_node_usrmanage},
    {"ntp",             dc_hdl_node_ntp},
    {"dns",             dc_hdl_node_dns},
    {"radiuss",         dc_hdl_node_radius},
    {"network",         dc_hdl_node_network},
    {"ether_interfaces",dc_hdl_node_ethif},
    {"vlans",           dc_hdl_node_vlan},
    {"vlan_interfaces", dc_hdl_node_vlan_interface}, 
    {"nat",             dc_hdl_node_nat}, 
    {"dialers",         dc_hdl_node_dialer},
    {"wlan",            dc_hdl_node_wlan},
    {"ports",           dc_hdl_node_vlan_port},
    {"interfaces",      dc_hdl_node_interface},
    {"capwap",          dc_hdl_node_capwap},
    {"probe",           dc_hdl_node_probe},  
    {"log",             dc_hdl_node_log},     
    {"wds",             dc_hdl_node_wds},     

...
#define		CWParseMessageElementEnd()				CWDebugLog_D("Parse message end");											\
...
#define		CW_IANA_ENTERPRISE_NUMBER			0	// 13277	/* maldini modified */
...
#define		CW_CONTROL_HEADER_LENGTH				8 /* 4bytes type, 1byte seq,2bytes length, 1byte flag */
#define     CW_MSGELEM_HEADER_LENGTH				4 /* 2bytes type, 2bytes length */
...
#define		CW_MSG_TYPE_VALUE_DEVICE_CONTROL_REQUEST		1001
#define		CW_MSG_TYPE_VALUE_DEVICE_CONTROL_RESPONSE		1002
...
#define 	CW_MSG_ELEMENT_RESULT_CODE_CW_TYPE_WITH_PAYLOAD		50

#define     CW_MSG_ELEMENT_WTP_DEVINFO_CW_TYPE          100
#define		CW_MSG_ELEMENT_WTP_MAC_CW_TYPE				5000
#define		CW_MSG_ELEMENT_WTP_DEVICE_CONTROLINFO_CW_TYPE		6001
#define		CW_MSG_ELEMENT_WTP_DEVICE_CONTROLRESULT_CW_TYPE		6002
#else

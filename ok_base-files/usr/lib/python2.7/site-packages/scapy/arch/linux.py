...
def attach_filter(s, filter):
    ...
    try:
        ...
        print >> sys.stderr, "%s -i %s -ddd -s 1600 '%s'" % (conf.prog.tcpdump,conf.iface,filter)
    except OSError,msg:
        log_interactive.warning("Failed to execute tcpdump: (%s)")
        return
    lines = f.readlines()
    print >> sys.stderr, "%s" % lines
    if f.close():
    ...
    import binascii
    print >> sys.stderr, binascii.b2a_hex(bpfh)
    print >> sys.stderr, binascii.b2a_hex(bpf)

...
strongswan pki --self --ca --lifetime 3650 --in private/strongswanKey.pem --type rsa --dn "C=CH, O=OAKRIDGE-VPS-CENTOS, CN=$CN" --outform pem > cacerts/strongswanCert.pem
...
strongswan pki --pub --in private/vpnHostKey.pem --type rsa | \
	...
	--dn "C=CH, O=OAKRIDGE-VPS-CENTOS, CN=$CN" \
	--san $CN \

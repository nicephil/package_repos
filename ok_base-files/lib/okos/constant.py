...
const.PORT_MAPPING = [
        {'type': const.DEV_CONF_PORT_TYPE['wan'], 'ifname': 'wan', 'logic': 'e0', 'phy': 'eth1'},
        {'type': const.DEV_CONF_PORT_TYPE['wan'], 'ifname': 'wan1', 'logic': 'e1', 'phy': 'eth2'},
        {'type': const.DEV_CONF_PORT_TYPE['wan'], 'ifname': 'wan2', 'logic': 'e2', 'phy': 'eth3'},
        {'type': const.DEV_CONF_PORT_TYPE['lan'], 'ifname': 'lan', 'logic': 'e3', 'phy': 'eth0'},
